...
session_start();//para corrigir login e senha
    ...
    <header>
        <div class="container">
            ...
            <form action="valida_login.php" method="POST">
                ...
                <?php if(isset($_SESSION['Login']) && $_SESSION['Login'] == 'erro') { ?>                    
            ...
            <?php if(empty($_POST['senha'])) {echo '<span class="aviso">Favor preencher o campo senha</span>'; } ?>
                ...
                <?php if(isset($_SESSION['valida']) && $_SESSION['valida'] == 'erro'){ ?>                    
                    <?php echo '<span class="aviso">Email ou Senha incorreto</span>'?>                    
                <?php } ?>
